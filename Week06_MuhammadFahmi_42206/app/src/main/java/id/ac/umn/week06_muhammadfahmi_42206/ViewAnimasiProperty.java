...
public class ViewAnimasiProperty extends View {
    ...
    public ViewAnimasiProperty(Context context) {
        super(context);
    }

    public ViewAnimasiProperty(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
